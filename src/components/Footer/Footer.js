...
class Footer extends Component  {
    ...
    return (
        ...
        <footer className="footer d-flex justify-content-center">
            ...
            <a href="https://drive.google.com/file/d/1bVxm7vubNbH8eS0qrormKvvfZagDKLo6/view?usp=sharing" target="_blank"><i className="fas fa-file-alt m-3 fa-3x footer-icon hvr-wobble-skew"></i></a>
        </footer>
        );
    };
};
