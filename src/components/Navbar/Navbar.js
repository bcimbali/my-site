      ...
      <nav class="bg-color border-bottom border-dark d-flex navbar navbar-expand-lg navbar-light sticky-top">
        ...
        <div class="collapse navbar-collapse mx-auto" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto nav-list-font">
            <a class="hvr-buzz nav-item nav-link px-2 text-dark" href="#section2">About</a>
            <a class="hvr-buzz nav-item nav-link px-2 text-dark" href="#section3">Portfolio</a>
            <a class="hvr-buzz nav-item nav-link px-2 text-dark" href="#section4">Contact</a>
          </div>
        </div>
      </nav>
      );
