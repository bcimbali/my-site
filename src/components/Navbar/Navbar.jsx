...
function Navbar() {
  return (
    <nav className="bg-color border-bottom border-dark d-flex navbar flex-nowrap gray-font justify-content-center navbar-expand-lg navbar-light fixed-top nav-container">
